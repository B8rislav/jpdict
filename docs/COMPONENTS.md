...
| `SentenceCardView` | `Sentence/ui/SentenceCardView.tsx` | Token grid for a parsed sentence | `tokens: SentenceToken[]`, `onTokenClick` | none |
...
| `TokenRow` | `Sentence/ui/TokenRow.tsx` | Single token with POS-coloured label | `token: SentenceToken`, `onClick` | `TokenRow.stories.tsx` |
| `DictionaryWordCard` | `Dictionary/DictionaryWordCard/DictionaryWordCard.tsx` | Saved-word row with mastery status selector and delete | `word: SavedWord`, `onAdvanceStatus`, `onDelete` | `DictionaryWordCard.stories.tsx` |
...
| `DictionaryPanel` | `Dictionary/DictionaryPanel.tsx` | `$savedWords`, dictionary effects |
